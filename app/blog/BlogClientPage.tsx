          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <form onSubmit={handleEmailSubscription} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              <button
                ...
                className="bg-primary text-white px-6 py-3 rounded-lg font-medium hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            {subscriptionMessage && (
              <p
                className={`mt-4 text-sm text-center ${
                  subscriptionMessage.includes("Successfully") ? "text-green-600" : "text-red-600"
                }`}
              >
                {subscriptionMessage}
              </p>
