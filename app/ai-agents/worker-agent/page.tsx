...
export const metadata: Metadata = {
  ...
  keywords: "AI worker agent, task automation, workflow optimization, institutional knowledge, repetitive tasks, business process automation, AI automation, workflow software",
  ...
  alternates: {
    canonical: "/ai-agents/worker-agent",
  },
  openGraph: {
    title: "Worker Agent | Task Automation & Workflow Optimization | Confer Solutions AI",
    description: "Handle any repetitive task that requires instant access to institutional knowledge, freeing human staff to focus on high-value activities.",
    url: "https://confersolutions.ai/ai-agents/worker-agent",
    siteName: "Confer Solutions AI",
    images: [
      {
        url: "https://confersolutions.ai/og-worker-agent.jpg",
        width: 1200,
        height: 630,
        alt: "AI Worker Agent Dashboard",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Worker Agent | Task Automation & Workflow Optimization | Confer Solutions AI",
    description: "Handle any repetitive task that requires instant access to institutional knowledge, freeing human staff to focus on high-value activities.",
    images: ["https://confersolutions.ai/og-worker-agent.jpg"],
