...
export function FlowiseChat() {
  useEffect(() => {
    if (typeof window !== "undefined") {
      const existing = document.getElementById("flowise-chatbot")
      if (!existing) {
        const script = document.createElement("script")
        script.src = "https://cdn.jsdelivr.net/npm/flowise-embed/dist/web.js"
        script.id = "flowise-chatbot"
        script.async = true
        script.type = "module"
        script.onload = () => {
          if (window.Chatbot) {
            window.Chatbot.init({
              ...
              theme: {
                ...
                disclaimer: {
                  ...
                  message:
                    'Connect with our AI experts. By continuing, you agree to our <a target="_blank" href="https://confersolutions.ai/privacy" style="color: #3b82f6; text-decoration: underline;">Privacy Policy</a>',
                  textColor: "#1a1a1a",
                  buttonColor: "#1a1a1a",
                ...
                chatWindow: {
                  ...
                  titleAvatarSrc:
                    "https://raw.githubusercontent.com/walkxcode/dashboard-icons/main/svg/google-messages.svg",
                  welcomeMessage:
                    "Hello! I'm here to help you explore AI solutions for your business. What challenges are you looking to solve?",
                  errorMessage:
                    "I apologize for the technical difficulty. Please try again or contact us directly at info@confersolutions.ai",
                  backgroundColor: "#ffffff",
                  height: 600,
                  width: 380,
                  fontSize: 15,
        ...
        script.onerror = () => {
          console.error("Failed to load Flowise chat script")
        }
