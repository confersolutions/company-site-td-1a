...
<step_metadata>
  <creates>
    - directory: .agent-os-active/product/
    - files: 4
  </creates>
</step_metadata>
...
<step_metadata>
  <creates>
    - file: .agent-os-active/product/mission.md
  </creates>
</step_metadata>
...
<step_metadata>
  <creates>
    - file: .agent-os-active/product/tech-stack.md
  </creates>
</step_metadata>
...
<step_metadata>
  <creates>
    - file: .agent-os-active/product/roadmap.md
  </creates>
</step_metadata>
...
<phase_structure>
  <phase_count>3</phase_count>
  <features_per_phase>5-10</features_per_phase>
  <phase_template>
    ## Phase [NUMBER]: [NAME]
...
<phase_guidelines>
  - Phase 0: Already Completed (existing features)
  - Phase 1: Current Development (next priorities)
  - Future Phases: Long-term roadmap
</phase_guidelines>

<format_preferences>
  - Use simple checkbox format: - [ ] for pending, - [x] for completed
...
<instructions>
  ACTION: Create 3 development phases with simple checkbox format
  PRIORITIZE: Based on dependencies and mission importance
  FORMAT: Use simple checkbox format preferred by user
...
<step_metadata>
  <creates>
    - file: .agent-os-active/product/decisions.md
  </creates>
...
### Product Context
- **Mission & Vision:** @.agent-os-active/product/mission.md
- **Technical Architecture:** @.agent-os-active/product/tech-stack.md
- **Development Roadmap:** @.agent-os-active/product/roadmap.md
- **Decision History:** @.agent-os-active/product/decisions.md

### Development Standards
- **Code Style:** @.agent-os/standards/code-style.md
- **Best Practices:** @.agent-os/standards/best-practices.md
- **Quick Start:** @.agent-os/standards/quick-start.md
- **Development & Deployment:** @.agent-os/standards/development-deployment.md
- **Project Deployment:** @.agent-os/product/deployment.md

### Project Management
- **Active Specs:** @.agent-os-active/specs/
...
1. **First**, check @.agent-os-active/product/roadmap.md for current priorities
...
- Product-specific files in `.agent-os-active/product/` override any global standards
- User's specific instructions override (or amend) instructions found in `.agent-os-active/specs/...`
...
<final_checklist>
  <verify>
    - [ ] All 4 files created in .agent-os-active/product/
