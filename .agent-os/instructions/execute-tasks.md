...
<prerequisites>
  ...
  - Development environment configured (see @.agent-os/standards/quick-start.md)
...
<standards>
  <code_style>
    <follow>@.agent-os/standards/code-style.md</follow>
    <enforce>strictly</enforce>
  </code_style>
  <best_practices>
    <follow>@.agent-os/standards/best-practices.md</follow>
